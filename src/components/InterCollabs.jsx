            ...
            return <div className='indian-tab-content'>
                <div className="row">
                    <div class="col-md-4 col-12 mb-3 mb-md-0">
                        <div class="stats-card1 stats-card  text-white d-flex align-items-center justify-content-between p-4 rounded">
                            <div>
                                <h6 class="mb-1">Doctors</h6>
                                <h3 class="fw-bold">20k</h3>
                            </div>
                            <img src={doctorIcon1} alt="doctorIcon1" />
                        </div>
                    </div>
                    <div class="col-md-4 col-12 mb-3 mb-md-0">
                        <div class="stats-card2 stats-card  text-white d-flex align-items-center justify-content-between p-4 rounded">
                            <div>
                                <h6 class="mb-1">Medical Associations</h6>
                                <h3 class="fw-bold">20k</h3>
                            </div>
                    ...
                    <div class="col-md-4 col-12 mb-3 mb-md-0">
                        <div class="stats-card3 stats-card  d-flex  justify-content-between text-white  p-4 rounded">
                           
                            
                                <div>
                                     <h6 class="mb-1 ">Partner Hospitals</h6>
                                    <h3 class="fw-bold">20k</h3>
                                </div>
